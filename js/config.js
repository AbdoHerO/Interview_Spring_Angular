...
window.APP_CONFIG = {
  ...
  sections: {
    ...
    tests: [
      {
        id: 'java-test',
        title: 'Java Mock Test (EN)',
        type: 'quiz',
        path: 'tests/java.json',
        description: '60 questions: MCQ, multi-select, true/false and open. Get scored at the end.',
      },
      {
        id: 'java-test-fr',
        title: 'Java — Test blanc (FR)',
        type: 'quiz',
        path: 'tests/java-fr.json',
        description: '60 questions : QCM, choix multiples, vrai/faux et questions ouvertes. Score à la fin.',
      },
      {
        id: 'spring-boot-test',
        title: 'Spring Boot Mock Test (EN)',
        type: 'quiz',
        path: 'tests/spring-boot.json',
        description: '65 questions covering Spring Boot, Security, JPA, and microservices.',
      },
      {
        id: 'spring-boot-test-fr',
        title: 'Spring Boot — Test blanc (FR)',
        type: 'quiz',
        path: 'tests/spring-boot-fr.json',
        description: '65 questions sur Spring Boot, Security, JPA et microservices.',
      },
    ],
  },
